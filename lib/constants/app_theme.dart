...
class AppThemeData {
  ...
  static final TextTheme _textTheme = TextTheme(
    displayLarge: GoogleFonts.montserrat(fontWeight: _bold, fontSize: 20.0),
    labelSmall: GoogleFonts.oswald(fontWeight: _semiBold, fontSize: 16.0),
    displayMedium: GoogleFonts.oswald(fontWeight: _medium, fontSize: 16.0),
